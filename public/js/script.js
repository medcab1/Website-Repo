...
alert(pyrmont);
    ...
    function createMarkerFun(latLng,icon,name){
        ...
        var marker = new google.maps.Marker({
            ...
            icon: {
                ...
                scaledSize: new google.maps.Size(50, 50), // Set the desired size of the image
                },
    ...
    function distance(lat1, lon1, lat2, lon2) {
        ...
        //   function inputCharacterOnly(inputId,errorMessageId){
        //     // var input = document.querySelector('[name="'+inputId+'"]').value;
        //     var input =  document.querySelector('[name="'+inputId+'"]').nextSibling;
        //     var errorMessage=document.getElementById(inputId).nextSibling
        //     var pattern = /^[A-Za-z\s]+$/;
        
        //     if (pattern.test(input)) {
        //         errorMessage.textContent = "";
        //         // Input is valid, you can proceed with your logic
        //     } else {
