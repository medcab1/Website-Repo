...
<section class="header-top-margin py-5">
    <div class="container">
        ...
        <div class="secondary-text text-section">
            <p class="primary-text p-text text-center">
                Please read these terms and conditions carefully before using Our Service.<br />
                <br />
            </p>
            <strong>
                <p class="fs-1">Interpretation and Definitions</p>
            </strong>
            <p class="p-text">
                <strong class="fs-2">Interpretation</strong><br />
                The words of which the initial letter is capitalized have meanings defined under the following conditions.
                The following definitions shall have the same meaning regardless of whether they appear in singular or in
                plural.<br /><br />
                <strong class="fs-2">Definitions</strong><br />
            ...
            <br />
            <strong class="p-heading">Acknowledgment</strong>
