...
@section('title',"Customer Privacy Policy | MedCab")
@section('description',"Discover how our Privacy Policy empowers you with insights on accessing and utilizing our services. Uncover valuable information now!")
@section('keywords',"MedCab Customer Privacy Policy, MedCab Customer Privacy Terms, MedCab Customer Privacy Statement")
@section('main')
<style>
    .text-section>ul>li {
...
<section class="header-top-margin py-5">
    <div class="container">
        ...
        <div class="text-section secondary-text">
            ...
            <strong>
                <p class="fs-1 p-heading">Interpretation and Definitions</p>
            </strong>
            <p class="p-text">
            ...
            <strong class="p-heading fs-2">Collecting and Using Your Personal Data</strong>
            <strong class="fs-3">Personal Data</strong><br />
            ...
            <br />
            <strong class="fs-2">Required Information in Medcab consumer App</strong>
            <br />
            <ul>
            ...
            <!-- 
               <b> Medcab Driver App</b><br/>
                ...
                <br/> -->
            <p class="fs-3 p-heading"> Usage Data</p>
            ...
            <strong class="fs-2">Use of Your Personal Data</strong>
            <br />
            ...
            <br />
            <strong class="fs-2">Other legal requirements:</strong><br />
