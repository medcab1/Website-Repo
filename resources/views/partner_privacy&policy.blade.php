...
@section('title',"Partner Privacy Policy | MedCab")
@section('description',"Unlock the potential of our Privacy Policy: Gain valuable insights for our partners to access and make the most of our services effectively!")
@section('keywords',"MedCab Partner Privacy Policy, MedCab Partner Privacy Terms, MedCab Partner Privacy Statement")
@section('main')
<style>
   .text-section >ul>li{
