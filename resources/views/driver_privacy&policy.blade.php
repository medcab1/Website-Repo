...
@section('title',"Driver Privacy & Policy | MedCab")
@section('description',"Discover how our Privacy Policy empowers drivers by providing useful information and guidance for accessing and making the most of our services.")
@section('keywords',"MedCab Driver Privacy Policy, MedCab Driver Privacy Terms, MedCab Driver Privacy Statement")
@section('main')
<style>
   .text-section >ul>li{
        ...
        <div class="container">
            ...
            <div class="text-section">
               ...
               <b> Medcab Driver App</b><br/>
                ...
                <br/>
                <b class="p-heading text-center">Permission</b>
                <p class="p-text">
                Thank you for using our app. To provide you with the best possible experience, our app may
                require certain permissions to access various features on your device. We understand the
                importance of your privacy and want to be transparent about the information we collect and how
                we use it. We will only collect the data that is necessary to provide you with our services and will
                not use it for any other purpose without your consent.
                <br/>
                <br/>
                <b>Location</b><br/>
                Our app may require permission to access your location to provide you with location-based
                services such as maps, directions and nearby businesses.
                <br/>
                <br/>
                <b> User Personal Information</b><br/>
                Our app may request permission to access your personal information such as name, email
                address and phone number to allow you to create an account and use our services.
                <br/>
                <br/>
                <b>Battery Optimization</b><br/>
                Our app may require permission to optimize battery usage on your device to set the permanent
                location update so that the driver can get/find the nearest booking. Here are the different
                permission options that you may encounter when using our app:

                <br/>
                <br/><b>Open Battery Optimization</b><br/>
                If you have enabled battery optimization on your device and wish to allow our app to continue
                running in the background, this will help us to get your permanent location update so that you
                can get/find the nearest available booking.
                <br/>
                <br/><b>Disable Battery Optimization</b><br/>
                If you do not wish to allow battery optimization on your device, you may disable this feature
                entirely in your device settings. Please note that this may have an impact on your device's
                battery life. This will help us to get your permanent location update so that you can get/find the
                nearest available booking.
                <br/>
                <br/><b>Battery Optimization Disabled</b><br/>
                If battery optimization is disabled on your device, our app may continue running in the
                background, even when the device is not in use. This may impact your device's battery life but it
                will ensure that you receive timely notifications and updates from our app. This will help us to
                get your permanent location update so that you can get/find the nearest available booking.
                <br/>
                <br/>
                <b>All Battery Optimization Disabled</b><br/>
                If all battery optimization features are disabled on your device, our app will continue running in
                the background and may have a significant impact on your device's battery life. Please be
                aware of this when using our app. This will help us to get your permanent location update so
                that you can get/find the nearest available booking.
                <br/>
                <br/>
                <b>Auto Start (Enable)</b><br/>
                Our app may request permission to automatically start when your device is turned on to ensure
                that you receive timely notifications and updates.<BR/>
                We take your privacy seriously and will only use the information collected to provide you with
                our services. If you have any questions or concerns about our app permissions, please do not
                hesitate to contact us. Thank you for choosing our app!

                <br/>
                <br/>
                <b>Location Always:</b><br/>
                We utilize location services on our Site/App to deliver content and services that depend on
                knowing your real-time location, such as enabling passengers to locate drivers and allowing
                drivers to find passengers for pick-up, as well as calculating applicable fares for your journeys.
                It's important to note that we only collect your live location if you have specified in your settings
                that you would like us to "always collect" it. If you haven't specified this, we do not collect your
                live location unless you are actively using the Site/App or availing our services. Alternatively,
                you can manually input your location within the Site/App. However, please be aware that without
                the ability to collect your location, we will be unable to provide our services to you.
                <br/>
                <br/>
                <b>Notification:</b><br/>
                The App requests permission to send notifications to keep you updated with important
                information such as new ride requests, passenger updates and other relevant notifications that
                are crucial for ensuring a smooth and efficient driver-passenger experience.
                <br/>
                <br/>
                <b>Camera, File and Media:</b><br/>
                The Driver App requires access to your device's media, including gallery photos and camera, to
                enable you to upload images or capture photos for ride-related documentation, verification
                purposes or any necessary visual content.
                <br/>
                <br/>
                <b>Critical Alert:</b><br/>
                The App requests permission to utilize alert types, such as ringer or alarm, to ensure prompt
                notification in case of emergency situations. This permission allows the app to deliver crucial
                alerts, ensuring the safety and security of drivers during critical incidents.
                <br/>
                <br/>
                </p>
