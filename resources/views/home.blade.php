    ...
    function getLatLng(address,lat_id,lng_id){
        ...
        geocoders.geocode(
                ...
                function(result,status){
                    ...
                    location.push({'lat':lat});
                    location.push({'lng':lng});
                    $('#'+lat_id).val(lat);
                    $('#'+lng_id).val(lng);
...
$('#submit-btn').click(function(){
    ...
    pickUp_autocomplete.setComponentRestrictions({'country': ['in']});
    ...
    drop_autocomplete.setComponentRestrictions({'country': ['in']});
