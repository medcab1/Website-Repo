    ...
    <div class="accordion" id="accordionExample">
        <div class="accordion-item">
            <h2 class="accordion-header mb-2" id="headingOne">
                <button class="accordion-button shadow-none collapsed rounded-4 d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                    <div class="d-flex align-items-center">
                        <img src="{{asset('assets/website-images/Q.png')}}" alt="q" />
                        <strong>
                            <p class="ms-3">
                                What payment modes do you accept for booking an ambulance?
                            </p>
                        </strong>
                    </div>
                    <!-- <p class="plus-icon">+</p> -->
        ...
        <div class="accordion-item">
            <h2 class="accordion-header mb-2" id="headingThree">
                <button class="accordion-button shadow-none collapsed rounded-4 d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                    <div class="d-flex align-items-center">
                        <img src="{{asset('assets/website-images/Q.png')}}" alt="q" />
                        <strong>
                            <p class="ms-3">
