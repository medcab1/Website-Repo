...
")
@section('main')
<section class="outer-container header-top-margin">
    <div class="container hospital-facilities-container py-4">
        ...
        <div class="search-bar">
            ...
            <div class="search-div">
                ...
                <input type="text" placeholder="Search facilities Here" name="search-city-name" id="facility-search">
            </div>
        ...
        <div class="facility-container">
            <div class="row justify-content-center">
                @foreach($data as $facility)
                 ...
                 <a href="https://medcab.in/hospital-services/{{$facility->hospital_serv_cat_name_sku}}">
                       <div class="h-facility-box">
                        <div class="h-facility-icon">
                            <img src="{{ env('DYNAMIC_IMAGE_URL') . '/' . $facility->hospital_serv_cat_icon }}" alt="{{ $facility->hospital_serv_cat_name }}">
                        </div>
                        ...
                        <div class="h-facility-arrow">
                            <!-- <a href="{{ route('services-category', $facility->hospital_serv_cat_name_sku) }}" class="check-avl-hospital" data-sku="{{ $facility->hospital_serv_cat_name_sku }}"> -->
